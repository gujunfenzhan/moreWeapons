...
public class WavefrontObject {
    ...
    private Face parseFace(String line, int lineCount) throws ModelFormatException {
        ...
        //OceanMemory.getLogger().info("瀵拷婵顦╅悶鍡涙桨");
        ...
        if (isValidFaceLine(line)) {
            ...
            if (isValidFace_V_VT_VN_Line(line)) {
                ...
                //OceanMemory.getLogger().info("TextureCoordinates闂�鍨:{}", tokens.length);
            ...
            // f v1//vn1 v2//vn2 v3//vn3 ...
                ...
                //OceanMemory.getLogger().info("濞屸剝婀乀extureCoordinates,閸掓稑缂撴妯款吇TextureCoordinates閺佹壆绮�");
                face.textureCoordinates = new TextureCoordinate[0];
